...
const columns = [
  {
    title: "Product",
    links: ["Features", "Pricing", "Changelog", "Download", "Integrations"],
  },
  {
    title: "Company",
  ...
  {
    title: "Resources",
    links: ["Help center", "Guides", "API docs", "Status", "Community"],
  },
  {
    title: "Legal",
...
export default function Footer() {
  return (
    <footer className="border-t border-line bg-paper">
      <Container>
        <div className="grid grid-cols-2 gap-10 py-16 md:grid-cols-[1.4fr_repeat(4,1fr)]">
